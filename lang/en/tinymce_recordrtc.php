...
$string['notpremium_title'] = 'Not a premium user';
$string['notpremium'] = 'Wrong credentials or user not found. Please update your credentials, or untick the "Use premium service" checkbox in the settings';
$string['servernotfound_title'] = 'No server found';
$string['servernotfound'] = 'Could not connect to server. This may be due to downtime or a server error, or the address may have changed';
